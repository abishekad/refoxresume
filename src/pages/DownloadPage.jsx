...
export default function DownloadPage({ user, isPaid, setPage, selectedTemplate }) {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const iframe = invisibleContainerRef.current;
  ...
  return (
    <div style={{ minHeight: "100vh", paddingTop: 100, display: "flex", flexDirection: "column", alignItems: "center", position: "relative", overflow: "hidden", background: C.bg }}>
      ...
      <iframe ref={invisibleContainerRef} title="Print Container" style={{ width: 794, height: 1123, position: 'absolute', opacity: 0, pointerEvents: 'none' }} />
    </div>
  );
}
